...
alias to-gems='cd ~/workspace/ekohe/gems/'
alias to-rails='cd ~/workspace/ekohe/gems/rails/'
alias to-ruby='cd ~/workspace/ekohe/gems/ruby/'
alias tnew='tmux new -s'
alias tls='tmux ls'
alias topen='tmux a -t'
alias tlast='tmux a' # 恢复至上一次的会话
